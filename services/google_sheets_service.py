...
class GoogleSheetsService:
    ...
    def _initialize_client(self, api_key: Optional[str] = None):
        ...
        """
        try:
            # Try using service account if credentials file exists
    ...
    def create_lead(self, user_id: str, username: str, message: str) -> Dict:
        ...
        try:
            ...
            logger.error(f"Failed to create lead for user {username}: {e}")
            raise
    ...
    def update_lead_status(self, user_id: str, status: str) -> bool:
        ...
        try:
            ...
            # Update status (assuming status is in column 3)
            for cell in cells:
                row = cell.row
